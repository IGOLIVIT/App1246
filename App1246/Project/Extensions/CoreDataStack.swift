...
class CoreDataStack {
    ...
    func deleteSched(withScTit name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<SchedModel> = SchedModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "scTit == %@", name)
    ...
    func deletePay(withPaTit name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<PaymentModel> = PaymentModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "paTit == %@", name)
